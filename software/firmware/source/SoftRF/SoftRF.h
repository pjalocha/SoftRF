...
#define SOFTRF_FIRMWARE_VERSION "PJ001"
...
enum
{
	...
	SOFTRF_SHUTDOWN_EXTPWR,
	SOFTRF_SHUTDOWN_SENSOR,
	SOFTRF_SHUTDOWN_CHARGE
};
...
{
  return (0x00800000 | (id & 0x000FFFFF));   // may be mapped to 0087xxxx in SoftRF.ino for transmissions
}
